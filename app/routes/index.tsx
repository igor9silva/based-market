		...
		<div className="flex flex-col gap-12">
			<div className="gap-6 grid grid-cols-1 lg:grid-cols-2">
				<h1 className="text-6xl font-bold text-balance text-white m-0">
					TanStack <span className="text-cyan-500">Start</span>,
					TanStack
				...
				<div className="flex flex-col gap-4 not-prose lg:row-start-2">
					<p className="text-xl font-light text-slate-300">
						TanStack Start is coming. The best way to use Convex
						with Start is via React Query's excellent Start
						integration. This site is{' '}
					...
					<p className="text-xl font-light text-slate-300">
						You can jump straight to the quickstart or read more to
						learn about using Convex with Start. There's a lot more
						to TanStack Start so also check out the{' '}
