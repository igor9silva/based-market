...
export function WorldcoinLogo({ className }: { className?: string }) {
	//
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="110 44 226 226"
			className={cn('size-6 fill-accent-foreground', className)}
			aria-label="Worldcoin Logo"
		>
			<path
