		...
		<div className={cn('whitespace-normal [&>*]:break-all h-full', className)}>
			<Component
				components={{
					...
					h1: ({ children }) => <h1 className="text-2xl font-bold text-primary mt-6 mb-2">{children}</h1>,
					h2: ({ children }) => <h2 className="text-xl font-bold text-primary mt-5 mb-2">{children}</h2>,
					h3: ({ children }) => <h3 className="text-lg font-bold text-primary mt-4 mb-2">{children}</h3>,
					h4: ({ children }) => <h4 className="text-base font-bold text-primary mt-3 mb-2">{children}</h4>,
					h5: ({ children }) => <h5 className="text-sm font-bold text-primary mt-2 mb-1">{children}</h5>,
					h6: ({ children }) => <h6 className="text-xs font-bold text-primary mt-2 mb-1">{children}</h6>,
